		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#devicerecognition-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devicerecognition-display": {
								"semanticObject": "devicerecognition",
								"action": "display",
								"description": "Mares Device Recognition",
								"title": "Device Recognition",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=devicerecognition",
									"url": sap.ui.require.toUrl("devicerecognition")
								}
							}
						}
					}
